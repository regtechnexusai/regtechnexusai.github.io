(() => {
  ...
  const reportLogoFallback = 'https://regtechnexusai.com/regtech-nexus-ai-logo-2026.png';

  const getEmbeddedReportLogo = async () => {
    try {
      const response = await fetch('../regtech-nexus-ai-logo-2026.png', { cache: 'no-store' });
  ...
  const makeReport = async () => {
    ...
    const reportLogo = await getEmbeddedReportLogo();
